            ...
            <section className='single-room'>
              ...
              <div className='single-room-info'>
                ...
                <article className='info'>
                  <h3>Information:</h3>
                  <h6>{`Price : ${props?.room?.data?.room_price}.000 VND`}</h6>
                  <h6>{`Size : ${props?.room?.data?.room_size} m`}</h6>
                  <h6>
                    Max capacity :
                    {props?.room?.data?.room_capacity > 1 ? `${props?.room?.data?.room_capacity} people` : `${props?.room?.data?.room_capacity} person`}
                  </h6>
